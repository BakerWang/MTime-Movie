...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        [self _createPosterCollectionView];//创建大海报
        [self _createBottomTitleLable];//创建底部电影名字标题

        [self _createCoverView];//创建阴影
        
        [self _createHeaderView];//创建小海报的view容器
